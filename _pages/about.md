...
I am excited about the opportunity to leverage machine learning approaches to solve dynamic, real-world problems in technology. In my opinion, the most compelling realization of artificial intelligence is with everyday digiital assistants. My goal is to create end-to-end digital agents that can few-shot learn and rapidly generalize to a distribution of unseen tasks.
